...
class FileInfo:
    ...
    def getBase64(self, obj=None):
        ...
        res = []
        while True:
            chunk = f.read(FileInfo.BYTES)
            if not chunk: break
            res.append(chunk.encode('base64'))
        return ''.join(res)
...
class File(Field):
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
                 ...
                 label=None, isImage=False, downloadAction=None, sdefault='',
                 scolspan=1, swidth=None, sheight=None, view=None, xml=None):
