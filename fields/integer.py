...
class Integer(Field):
    pxView = pxCell = Px('''
     <x>::field.getInlineEditableValue(obj, value)</x>
    ...
    pxEdit = Px('''
     ...
     <script if="hostLayout">:'prepareForAjaxSave(%s,%s,%s)' % \
      (q(name),q(obj.id),q(obj.url))</script>''')
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
                 ...
                 sheight=None, persist=True, inlineEdit=False, view=None,
                 xml=None):
