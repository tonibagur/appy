...
class Resource:
    ...
    def get(self, uri=None, headers={}, params=None, followRedirect=True):
        ...
        res = self.send('GET', uri, headers=headers)
        # Follow redirect when relevant
        if (res.code == 302) and followRedirect: return self.get(res.data)
        return res
    rss = get
